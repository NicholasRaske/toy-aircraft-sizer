...
excrescence allowances hand-authored:
    ...
    clean       0.011846 + 0.003586 + 0.002617 = 0.018049 m^2
    excrescence 0.001500 + 0.000800 + 0.017000 = 0.019300 m^2
    CD0 = 0.037349 / 1.6 = 0.023343
    AR  = 3.8^2 / 1.6 = 9.0250
    e   = 0.7586 (from the catalogue, not the Raymer correlation)
    k   = 1 / (pi x 9.025 x 0.7586) = 0.046492
    L/D = 1 / (2 sqrt(0.046492 x 0.023343)) = 15.18
"""
...
EXPECTED_ZERO_LIFT_DRAG = 0.023343
EXPECTED_INDUCED_FACTOR = 0.046492
EXPECTED_LIFT_TO_DRAG_MAX = 15.18
